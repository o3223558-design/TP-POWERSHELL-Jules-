#il demande les information de l'utilisateur pour la suite 
...
# la c'est la parti ou il calcule le temps de someil 
if ($reveil -ge $coucher) {
#	
    $sommeil = $reveil - $coucher
#si l’heure de réveil est aprè ou égale à l’heure de coucher
#23 - 21 = 2 heures de sommeil
} else {
    $sommeil = (24 - $coucher) + $reveil
#La nuit et cut en 2 parti, 24 - 23 = 1 heure et donc aprés 7 heures et hop 1 + 7 = 8 heures
}
...
if ($age -ge 18) {
    ...
    $recommande = 9
# je ne c'est pas si c les bonne valeur c'est qu'un exemple	
}

# affiche si c'est une bonne nuit ou pas
...
# les pipe ( | ) sa permet d'avoir tout sur une seule ligne)
